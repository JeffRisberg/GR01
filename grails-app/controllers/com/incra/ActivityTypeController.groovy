      ...
      if (params.version) {
        ...
        if (activityTypeInstance.version > version) {
          ...
          activityTypeInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [
            message(code: 'activityType.label', default: 'ActivityType')]
          as Object[], "Another user has updated this ActivityType while you were editing")
